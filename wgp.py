...
#Er
import runpy, os
hook = os.path.join(os.path.dirname(__file__), "Er_video_info_autohook.py")
if os.path.exists(hook): runpy.run_path(hook, run_name="__autohook__")
#

import os
>>>>>>> b0abca4 (Video info in cmd _ +2 addon folders)
